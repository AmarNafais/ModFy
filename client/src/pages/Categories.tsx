  ...
  return (
    <div className="pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Categories Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12" data-testid="categories-grid">
              ...
              <Link href={`/shop?category=${category.slug}`}>
                <a className="group block">
                  ...
                  <div className="text-center">
                    <h2 className="text-xl font-light tracking-wide mb-2" data-testid={`category-name-${category.id}`}>
                      {category.name?.toUpperCase() || ''}
                    </h2>
                    <p className="text-sm text-gray-600 font-light mb-3" data-testid={`category-desc-${category.id}`}>
