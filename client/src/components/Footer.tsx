        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3 mb-4">
              <div>
                <a 
                  href={`mailto:${settings?.email || 'info@modfy.com'}`}
                  className="text-sm text-gray-600 font-light hover:text-luxury-black transition-colors block"
                >
                  {settings?.email || 'info@modfy.com'}
                </a>
              </div>

              <div>
                <a 
                  href={`tel:${settings?.phoneNumber || '+94777466766'}`}
                  className="text-sm text-gray-600 font-light hover:text-luxury-black transition-colors block"
                >
                  {settings?.phoneNumber || '+94 777 466 766'}
                </a>
              </div>

              <div>
                <p className="text-sm text-gray-600 font-light leading-relaxed">
                  195/1, Sri Saranankara Road,<br />
                  Dehiwala 10350
                </p>
              </div>
            </div>
