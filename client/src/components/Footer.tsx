    ...
    <footer className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-sm font-medium tracking-wide mb-4">NEWSLETTER</h3>
            <p className="text-sm text-gray-600 font-light mb-4">Subscribe to receive updates, access to exclusive deals, and more.</p>
            <button 
              className="bg-luxury-black text-white px-6 py-2 text-xs font-medium tracking-wide hover:bg-gray-800 transition-colors"
        ...
        <div className="border-t border-luxury-muted pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-xs text-gray-600 font-light mb-4 md:mb-0">
              MODFY MEN'S FASHION HOUSE LTD
            </p>
            <div className="flex items-center space-x-6">
              <div className="flex space-x-4">
                <a href="https://wa.me/94777466766" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-luxury-black cursor-pointer transition-colors" data-testid="link-whatsapp">
                  <FaWhatsapp className="w-4 h-4" />
                </a>
                <a href="https://www.instagram.com/modfyofficial" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-luxury-black cursor-pointer transition-colors" data-testid="link-instagram">
                ...
                <a href="https://www.facebook.com/share/1BPUVhhXYR/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-luxury-black cursor-pointer transition-colors" data-testid="link-facebook">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://www.tiktok.com/@modfy.official" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-luxury-black cursor-pointer transition-colors" data-testid="link-tiktok">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
